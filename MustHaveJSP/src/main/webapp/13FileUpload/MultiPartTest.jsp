...
<body>
	<h3>MultiPartTest</h3>
	<span style="color: red;">${errorMaessage }</span>
	<form action="TestProcess.do" method="post" enctype="multipart/form-data" onsubmit="return validateForm(this);">
		...
		연령대(선택사항) :
			<input type="radio" name="sel" value="10" />~10대
			<input type="radio" name="sel" value="20" checked />20대
		...
		첨부 파일 : <input type="file" name="ofile" multiple /> <br />
